...
type SymmCipher struct {
	encryptCipher any //cipher.BlockMode | cipher.Stream
	decryptCipher any //cipher.BlockMode | cipher.Stream
	key           []byte
...
func (sc *SymmCipher) getEncrypter(workMode int, block cipher.Block, iv []byte) (ret any, err error) {
	switch workMode {
	case ECB_MODE:
...
func (sc *SymmCipher) getDecrypter(workMode int, block cipher.Block, iv []byte) (ret any, err error) {
	switch workMode {
	case ECB_MODE:
