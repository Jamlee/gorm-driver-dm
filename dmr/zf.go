...
func formatTrace(source string, method string, returnValue any, params ...any) string {
	var str string
	if source != "" {
		str += "{ " + source + " } "
	}
...
func formatReturn(returnObj any) string {
	var str string
...
func (record *LogRecord) Set(source any, method string, params ...any) {
	record.source = formatSource(source)
	record.method = method
	record.params = params
}

func (record *LogRecord) SetReturnValue(retValue any) {
	if retValue == nil {
...
func (record *LogRecord) GetReturnValue() any {
