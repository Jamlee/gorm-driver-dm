...
//
// 则绑入绑出的go对象为: val := dm.NewDmArray("myArray", []any {123, 456})
func NewDmArray(typeName string, elements []any) *DmArray {
	da := new(DmArray)
...
// 获取Array对象的go数组对象
func (da *DmArray) GetArray() (any, error) {
...
func (da *DmArray) GetObjArray(index int64, count int) (any, error) {
	var err error
	if err = da.checkValid(); err != nil {
		return nil, err
	}
...
func (dest *DmArray) Scan(src any) error {
	if dest == nil {
