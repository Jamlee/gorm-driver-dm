...
//
// 则绑入绑出的go对象为: val := dm.NewDmStruct("myType", []any {123, "abc"})
func NewDmStruct(typeName string, elements []any) *DmStruct {
	ds := new(DmStruct)
...
func (dest *DmStruct) Scan(src any) error {
	if dest == nil {
...
// 获取Struct对象中的各个字段的值
func (ds *DmStruct) GetAttributes() ([]any, error) {
