...
func connExecAfter(conn *DmConnection, sql string, args any, updateCount int) {
...
func connQueryAfter(conn *DmConnection, sql string, args any, resultSet *DmRows) {
	if resultSet != nil {
...
func stmtExecAfter(stmt *DmStatement, args any, updateCount int) {
...
func stmtQueryAfter(stmt *DmStatement, args any, resultSet *DmRows) {
	if resultSet != nil {
...
func internalAfterConnExecute(conn *DmConnection, args any, updateCount int) {
...
func internalAfterStatementExecute(stmt *DmStatement, args any, updateCount int) {
	nowNano := time.Now().UnixNano()
...
func buildSlowParameters(args any) string {
	switch v := args.(type) {
	case []driver.Value:
...
func buildStmtSlowParameters(stmt *DmStatement, args any) string {
	switch v := args.(type) {
	case []driver.Value:
		sb := bytes.NewBufferString("")
...
func connExecuteErrorAfter(conn *DmConnection, args any, err error) {
...
func statementExecuteErrorAfter(stmt *DmStatement, args any, err error) {
